...
public class KLineChartView extends BaseKLineChartView {
    ...
    private void initAttrs(AttributeSet attrs, Context context) {
        ...
        if (null != array) {
            try {
                ...
                setTextSize(array.getDimension(R.styleable.KLineChartView_text_size, getDimension(R.dimen.chart_text_size)));
                ...
                setGridLineColor(array.getColor(R.styleable.KLineChartView_gridLineColor, getColor(R.color.color_3C4152)));
                //图例
                ...
                setSelectedXLineColor(array.getColor(R.styleable.KLineChartView_selectXLineColor, getResources().getColor(R.color.color_white)));
    ...
    /**
     * set cross line show model
     *
     * @param showCrossModel {@link Status.ShowCrossModel} default SELECTBOTH
     */
    public KLineChartView setSelectedTouchModle(Status.ShowCrossModel showCrossModel) {
