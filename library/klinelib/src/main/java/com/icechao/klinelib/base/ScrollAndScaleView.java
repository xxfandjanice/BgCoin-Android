...
public abstract class ScrollAndScaleView extends RelativeLayout implements
    ...
    protected Status.ShowCrossModel model = Status.ShowCrossModel.SELECT_PRESS;
    ...
    public void onLongPress(MotionEvent e) {
        if (model == Status.ShowCrossModel.SELECT_PRESS || model == Status.ShowCrossModel.SELECT_BOTH) {
            showSelected = true;
            onSelectedChange(e);
        }
    }
