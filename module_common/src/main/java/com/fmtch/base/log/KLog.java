...
import com.fmtch.base.log.klog.BaseLog;
import com.fmtch.base.log.klog.FileLog;
import com.fmtch.base.log.klog.JsonLog;
import com.fmtch.base.log.klog.XmlLog;
...
public final class KLog {
	...
	private static void printLog(int type, String tagStr, Object... objects) {
		...
		String name = Thread.currentThread()
							.getName();
		headString = headString + "Thread:" + name + "-" + id + "\n";
		switch (type) {
			case V:
			case D:
			case I:
	...
	private static String[] wrapperContent(int stackTraceIndex, String tagStr, Object... objects) {
		...
		String msg = (objects == null) ?
				NULL_TIPS :
				getObjectsString(objects);
