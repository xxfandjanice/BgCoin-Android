package com.fmtch.base.net.dutil.download;
...
import com.fmtch.base.net.dutil.callback.DownloadCallback;
import com.fmtch.base.net.dutil.data.DownloadData;
import com.fmtch.base.net.dutil.db.Db;

import java.io.File;

import static com.fmtch.base.net.dutil.data.Consts.CANCEL;
import static com.fmtch.base.net.dutil.data.Consts.NONE;
import static com.fmtch.base.net.dutil.data.Consts.DESTROY;
import static com.fmtch.base.net.dutil.data.Consts.ERROR;
import static com.fmtch.base.net.dutil.data.Consts.FINISH;
import static com.fmtch.base.net.dutil.data.Consts.PAUSE;
