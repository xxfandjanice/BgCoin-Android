...
public class AndroidShare {
     ...
     * @param msgText  (分享内容)
     */
    public void shareTelegramMessage(String msgTitle, String msgText) {

        shareMsg("org.telegram.messenger", null,
                "Telegram", msgTitle, msgText, AndroidShare.TEXT, null);
    }
     ...
     * @param drawable (分享图片)
     */
    public void shareTelegram(String msgTitle, String msgText,
                              Bitmap drawable) {

        shareMsg("org.telegram.messenger", null,
                "Telegram", msgTitle, msgText, AndroidShare.DRAWABLE, drawable);
    }
