...
public class CircleImageView
	...
	public void setBorderColorResource(@ColorRes int borderColorRes) {
		...
		setBorderColor(getContext().getResources()
								   .getColor(borderColorRes));
	}
	 ...
	 *
	 * @param fillColorRes
	 * 		The color resource to be resolved to a color and
	...
	public void setFillColorResource(@ColorRes int fillColorRes) {
		...
		setFillColor(getContext().getResources()
								 .getColor(fillColorRes));
	}
