...
public class UploadConfig {
    ...
    //callback 测试地址
    public static final String OSS_CALLBACK_URL = "http://jyyp.oss-cn-beijing.aliyuncs.com";
    ...
    public static final String BUCKET_NAME = "jyyp";
    public static final String OSS_ACCESS_KEY_ID = "LTAIDXKDE9cj5YmB";
    public static final String OSS_ACCESS_KEY_SECRET = "KB2zDpUe5wtzVnDIaigv39OxPpNCg4";
