...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            BaseApplication.getApplication().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        } else {
            BaseApplication.getApplication().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        }
    }
