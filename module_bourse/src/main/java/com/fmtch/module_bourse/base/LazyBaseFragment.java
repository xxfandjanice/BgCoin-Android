...
public abstract class LazyBaseFragment extends BaseFragment {
    ...
    private boolean isParentInvisible() {
        ...
        if (parentFragment instanceof LazyBaseFragment) {
            LazyBaseFragment fragment = (LazyBaseFragment) parentFragment;
    ...
    private void dispatchChildVisibleState(boolean visible) {
        ...
        if (!fragments.isEmpty()) {
            for (Fragment child : fragments) {
                if (child instanceof LazyBaseFragment && child.isAdded() && !child.isHidden() && child.getUserVisibleHint()) {
                    ((LazyBaseFragment) child).dispatchUserVisibleHint(visible);
                }
            }
        }
    }
