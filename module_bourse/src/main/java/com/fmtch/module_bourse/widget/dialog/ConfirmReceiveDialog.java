...
public class ConfirmReceiveDialog {
    ...
    public ConfirmReceiveDialog(Context context) {
        ...
        mDialogLayout = inflater.inflate(R.layout.dialog_confirm_receive, null);
    }

    public ConfirmReceiveDialog setPaymentInfo(long dead_time, String pay_way, String pay_account, String pay_amount) {
    ...
    public ConfirmReceiveDialog setConfirmListener(View.OnClickListener listener) {
